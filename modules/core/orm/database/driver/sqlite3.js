/**
 * Conexão com banco de dados Sqlite 3
 *
 * @author  Adriano Moura
 */
'use strict'
/**
 * Mantém a conexão com o banco de dados sqlite 3
 */
...
class db {
	 ...
	 */
    constructor(config={}) {
        config.params   = config.params || [sqlite3.OPEN_READWRITE, sqlite3.OPEN_CREATE]
        this.db         = new sqlite3.Database(config.database, config.params, (err) => {
            if (err) {
